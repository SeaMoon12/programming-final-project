rooms = {
    ...
    'games room': {
        'introduction': 'Welcome to games room',
        'minigame_intro': 'Running games room game',
        'success': {
            'paranormal': 'You hear wow games room',
            'investigator': 'You analyze wow games room',
            'buyer': 'You see games room in your blueprint'
        },
        'fail': 'die games room'
    },
    'garage': {
        'introduction': 'Welcome to garage',
        'minigame_intro': 'Running garage game',
        'success': {
            'paranormal': 'You hear wow garage',
            'investigator': 'You analyze wow garage',
            'buyer': 'You see garage in your blueprint'
        },
        'fail': 'die garage'
    }
}
